...
--Cigarette
RegisterNetEvent('bcc-corehud:prop:cigaret')
AddEventHandler('bcc-corehud:prop:cigaret', function()
...
RegisterNetEvent('bcc-corehud:prop:cigar')
AddEventHandler('bcc-corehud:prop:cigar', function()
...
RegisterNetEvent('bcc-corehud:prop:pipe_smoker')
AddEventHandler('bcc-corehud:prop:pipe_smoker', function()
    FPrompt(Config.Drop, Config.Prompts.DropKey, false)
    LMPrompt(Config.Smoke, Config.Prompts.SmokeKey, false)
    EPrompt(Config.Change, Config.Prompts.ChangeKey, false)
    ExecuteCommand('close')
...
RegisterNetEvent('bcc-corehud:prop:chewingtobacco')
AddEventHandler('bcc-corehud:prop:chewingtobacco', function()
